...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CrashMapperClient; });
...
function () {
  ...
  _createClass(CrashMapperClient, [{
    key: "get",
    ...
    key: "post",
    value: function post(endpoint, body, params) {
      return this.httpClient.post(endpoint, body).then(function (response) {
        return response.data;
      });
    }
  }]);

  return CrashMapperClient;
}();
...
function () {
  ...
  _createClass(MapModule, [{
    ...
    key: "addGroup",
    value: function addGroup(groupName, incidents) {
      var markers = [];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _MapModule__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MapModule */ "./resources/js/MapModule.js");
/* harmony import */ var _CrashMapperClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CrashMapperClient */ "./resources/js/CrashMapperClient.js");
...
jquery__WEBPACK_IMPORTED_MODULE_2___default()('#app-add-incident').on('click', function (e) {
  map.chooseLocation().then(function (location) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default()('#add-incident-modal .lat').val(location.lat);
    jquery__WEBPACK_IMPORTED_MODULE_2___default()('#add-incident-modal .lng').val(location.lng);
  });
});
jquery__WEBPACK_IMPORTED_MODULE_2___default()('.app-incident-form').submit(function (e) {
  e.preventDefault();
  var incident = {
    'location': {
      'lat': jquery__WEBPACK_IMPORTED_MODULE_2___default()('[name=lat]', jquery__WEBPACK_IMPORTED_MODULE_2___default()(this)).val(),
      'lng': jquery__WEBPACK_IMPORTED_MODULE_2___default()('[name=lng]', jquery__WEBPACK_IMPORTED_MODULE_2___default()(this)).val()
    },
    'type': 'accident',
    'date': '2019-11-25'
  };
  crashMapperClient.post('incidents', incident).then(function (_) {
